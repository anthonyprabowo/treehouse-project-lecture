...
function addItems() {
  ...
  createItem(120, 200, 'coin');
  createItem(225, 150, 'coin');
  createItem(425, 100, 'coin');
  createItem(575, 125, 'coin');
  createItem(675, 220, 'coin');
  createItem(500, 275, 'coin');
}
...
function addPlatforms() {
  ...
  platforms.create(550, 175, 'platform');
  platforms.create(675, 285, 'platform');
  platforms.create(375, 325, 'platform');
